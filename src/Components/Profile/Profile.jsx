    ...
    <div className="w-4/5 mx-auto mb-10 mt-10 max-lg:w-full">
      ...
      <div className="px-4">
        ...
        <div className="relative">
          <img className="rounded-t-2xl h-46 max-md:h-40 max-xs:!h-32  max-sm:h-36 w-full" src="/banner.jpg"
          alt="banner"/>
          ...
          <Avatar className="w-48! h-48! max-md:!w-40 max-md:!h-40 border-mine-shaft-950 border-8 rounded-full max-sm:!h-36 max-sm:!w-36 max-xs:!h-32 max-xs:!w-32" src={profile.picture ? `data:image/jpeg;base64,${profile.picture}`:"/avatar-9.png"}/>
