...
function formatInterviewDateTime2(dateString) {
  const date = new Date(dateString);

  // Format date: "Thu, 27 November •"
...
export {formatDate,timeAgo,getBase64,formatInterviewTime,openBase64PDF,formatInterviewDateTime2}
